...
class LunaNutrition extends StatelessWidget {
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            const Text('Tap to log a meal with a photo',
                style: TextStyle(fontSize: 12, color: textMuted)),
            const SizedBox(height: 4),
            const Text('Add today\'s meal',
                style: TextStyle(
                    fontSize: 13,
                    color: champagneGold,
    ...
    return _card(
      children: [
        const Text('Today\'s Meals',
            style: TextStyle(
                fontFamily: 'DM Serif Display', fontSize: 18, color: textDeep)),
        const SizedBox(height: 14),
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text(label,
                style: const TextStyle(
                    fontSize: 9, color: textSoft, letterSpacing: 1)),
          ],
        ),
      ),
    );
  ...
  Widget _buildActivityCard() {
    return _card(
      ...
      children: [
        const Text('Today\'s Activity Context',
            style: TextStyle(
                fontFamily: 'DM Serif Display', fontSize: 18, color: textDeep)),
        const SizedBox(height: 10),
        Row(
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            const Text('School + swimming + 2hr play',
                style: TextStyle(fontSize: 13, color: textMuted)),
            Text('est. 1,800 kcal',
                style:
                    TextStyle(fontSize: 11, color: textSoft.withOpacity(0.8))),
          ],
        ),
        const SizedBox(height: 8),
        Text(
            'Higher activity days need more protein for recovery and steady carbs for energy.',
            style: TextStyle(
                fontSize: 12, color: textMuted.withOpacity(0.9), height: 1.7)),
      ],
    );
  }
  ...
  Widget _buildEnergyCard() {
    return _card(
      children: [
        const Text('Energy & Sleep Pattern',
            style: TextStyle(
                fontFamily: 'DM Serif Display', fontSize: 18, color: textDeep)),
        const SizedBox(height: 10),
        Text(
            'Energy dipped mid-afternoon yesterday after a poor night\'s sleep. The two are linked — consider a small protein snack at 3pm on busy days.',
            style: TextStyle(
                fontSize: 12, color: textMuted.withOpacity(0.9), height: 1.7)),
        const SizedBox(height: 6),
        Container(
  ...
  Widget _buildLunaNote() {
    return _card(
      ...
      children: [
        const Text('Luna\'s Note 🌙',
            style: TextStyle(
                fontFamily: 'DM Serif Display', fontSize: 18, color: textDeep)),
        const SizedBox(height: 10),
        Text(
            'Today looks slightly low on protein for an active day. Consider adding a simple recovery snack — cheese, edamame, or hard-boiled egg.',
            style: TextStyle(
                fontSize: 12, color: textMuted.withOpacity(0.9), height: 1.7)),
      ],
    );
