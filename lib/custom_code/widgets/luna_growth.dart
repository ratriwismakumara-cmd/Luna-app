        ...
        child: Column(
          ...
          children: [
            ...
            _buildGrowthCard(
              ...
              barWidth: 0.78,
              note:
                  'Your child is increasingly able to name emotions and take space before reacting.',
              sourceLabels: [
            ...
            _buildGrowthCard(
              ...
              barWidth: 0.65,
              note:
                  'Initiating play · sharing · handling disagreement · expressing needs',
              sourceLabels: [
                _SourceLabel('📝 Parent logs', 'parent-log'),
                _SourceLabel('🏫 School report', 'school'),
              ],
              framework:
                  '✦ Framework: SEL · IB Learner Profile (Communicator, Caring)',
            ),
            SizedBox(height: 14),
            _buildGrowthCard(
              ...
              barWidth: 0.85,
              note:
                  'Shows above-age verbal expression based on uploaded assessment.',
              sourceLabels: [
                _SourceLabel('📊 Uploaded assessment', 'assessment'),
                _SourceLabel('🏫 School report', 'school'),
              ],
              framework:
                  '✦ Source: school report (Apr 2026), psychotest assessment',
            ),
            SizedBox(height: 14),
            // Areas to Nurture
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: lunaPurple.withOpacity(0.07),
                      blurRadius: 26,
                      offset: Offset(0, 10)),
                  BoxShadow(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 12),
                  _areaItem(
                      'Perfectionism — hard on themselves when things aren\'t right'),
                  _areaItem(
                      'Transition resilience — struggles stopping one activity for another'),
                  _areaItem(
                      'Sleep consistency — bedtime resistance peaks on school nights'),
                  SizedBox(height: 8),
                  Text('✦ Framework: Gardener Philosophy · Whole-Brain Child',
                      style: TextStyle(
                          fontSize: 10,
                          color: lunaPurple,
                          fontStyle: FontStyle.italic,
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
              child: Text(text,
                  style:
                      TextStyle(fontSize: 12, color: textMuted, height: 1.7))),
        ],
      ),
    );
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  ...
                  foreground: Paint()
                    ..shader =
                        LinearGradient(colors: [lunaPurple, champagneGold])
          ...
          SizedBox(height: 12),
          Text(note,
              style: TextStyle(fontSize: 12, color: textMuted, height: 1.7)),
          SizedBox(height: 8),
          Wrap(
            spacing: 6,
            runSpacing: 6,
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 4),
                Text(
                    'Upload reports to deepen Luna\'s understanding — psychotest, school feedback, developmental notes.',
                    style: TextStyle(
                        fontSize: 11,
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(status,
                style:
                    TextStyle(fontSize: 9, color: isAdd ? textSoft : textSoft)),
          ],
        ),
      ),
    );
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient:
                LinearGradient(colors: [Color(0xFFD8B67A), Color(0x00D8B67A)]),
