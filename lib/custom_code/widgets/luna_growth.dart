...
class LunaGrowth extends StatelessWidget {
    ...
    return Container(
        ...
        child: SingleChildScrollView(
            ...
            child:
              ...
              SizedBox(height: 12),
              Row(children: [
                _card('Language', '1200+ words', 'Above avg', '📊 Assess.',
                    lavender),
                SizedBox(width: 12),
                _card('Social', 'Cooperative', 'On track', '🏫 School',
                    Color(0xFFB9A7D9)),
              ]),
              SizedBox(height: 24),
              Text('Milestones',
              ...
              _milestone(
                  'Reading simple words', false, 'Expected 48 months', gold),
            ])));
  }

  Widget _card(
      String label, String value, String sub, String source, Color accent) {
    return Expanded(
        child: Container(
  ...
  Widget _milestone(String name, bool ok, String note, Color accent) {
    return Card(
        ...
        child: ListTile(
          leading: Icon(ok ? Icons.check_circle : Icons.circle_outlined,
              color: ok ? accent : Colors.grey[400]),
          title: Text(name, style: TextStyle(fontSize: 14)),
          subtitle:
              Text(note, style: TextStyle(fontSize: 11, color: Colors.grey)),
        ));
  }
}
