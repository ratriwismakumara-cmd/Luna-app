...
/// LunaOnboarding — 7-step onboarding flow Replaces LunaChat as the landing
...
class _LunaOnboardingState extends State<LunaOnboarding> {
  ...
  Widget _buildStep(int step) {
    switch (step) {
      ...
      case 2:
        return _buildWhosParenting();
      case 3:
        return _buildChildProfile();
      case 4:
        return _buildParentingStyle();
      case 5:
        return _buildPriorities();
      case 6:
        return _buildHowLunaGuides();
      case 7:
        return _buildReady();
      default:
        return _buildWelcome();
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              padding: EdgeInsets.symmetric(
                  horizontal: isLast ? 28 : 30, vertical: isLast ? 14 : 13),
  ...
  Widget _buildWelcome() {
    return _onboardStep(
      ...
      subtitle:
          'A calm space to reflect, understand, and grow together with your child. No judgment. No pressure.',
      extra: Container(
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(
                      color: selected ? lunaPurple : lineSoft, width: 1.5),
                ),
                child: Center(
                  child: Text(role,
                      style: TextStyle(
                          fontSize: 13,
                          color: selected ? lunaPurple : textDeep,
                          fontWeight:
  ...
  Widget _buildChildProfile() {
    return _onboardStep(
      ...
      subtitle:
          'Age, personality, and what makes them unique. The more Luna understands, the more personal the guidance becomes.',
      extra: Padding(
            ...
            Container(
              ...
              child: TextField(
                decoration: InputDecoration.collapsed(
                    hintText: 'Child\'s age (e.g., 8 years)'),
      ...
      extra: Padding(
        ...
        child: Column(
          children: [
            _buildGuideCard(
                '✦ Personalized',
                'Luna learns from your child\'s profile and daily moments you share.',
                lunaPurple),
            SizedBox(height: 10),
            _buildGuideCard(
                '📚 Framework-backed',
                'Luna uses trusted parenting frameworks — Whole-Brain Child, Emotion Coaching, CASEL, IB, and more.',
                champagneGold),
            SizedBox(height: 10),
            _buildGuideCard(
                '🔒 Private',
                'Your family data stays encrypted and family-only. You control everything.',
                softLavender),
          ],
        ),
      ),
  ...
  Widget _buildReady() {
    return _onboardStep(
      ...
      title: 'You\'re ready',
      subtitle:
          'Luna will grow with your family — learning patterns, remembering moments, and helping you parent with intention.',
      extra: Column(
        children: [
          Padding(
            padding: EdgeInsets.symmetric(vertical: 8),
          ...
          Container(
            ...
            child: Text(
              ...
              style: TextStyle(
                  fontSize: 11, color: lunaPurple, fontWeight: FontWeight.w500),
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: softLavender.withOpacity(0.25),
                    blurRadius: 24,
                    offset: Offset(0, 8))
              ],
            ),
          ...
          Text(subtitle,
              textAlign: TextAlign.center,
              style: TextStyle(fontSize: 13, color: textMuted, height: 1.75)),
          SizedBox(height: 16),
          extra,
          SizedBox(height: 4),
        ...
        return GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              borderRadius: BorderRadius.circular(16),
              border: Border.all(
                  color: isSelected ? lunaPurple : lineSoft, width: 1.5),
            ),
            child: Text(
              item,
              style: TextStyle(
