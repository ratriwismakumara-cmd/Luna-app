          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                      color: lunaPurple.withOpacity(0.3),
                      blurRadius: 30,
            ...
            _buildProfileCard(
              ...
              rows: const [
                ...
                _InfoRow(
                    label: 'Personality',
                    value: 'Sensitive · Curious · Thoughtful'),
                _InfoRow(
                    label: 'Learning style', value: 'Reflective · Conceptual'),
              ],
            ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          ...rows.map((row) =>
              _buildInfoRow(row.label, row.value, valueColor: row.valueColor)),
        ],
      ),
    );
  }
  ...
  Widget _buildKnowledgeCard() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('What Luna knows about your family',
              style: TextStyle(
                  fontFamily: 'DM Serif Display',
                  fontSize: 18,
                  color: lunaPurple)),
          ...
          _knowledgeItem(
              'Patterns: evening overwhelm, perfectionism, transition resistance'),
        ],
      ),
    );
  }
  ...
  Widget _knowledgeItem(String text) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Text('✦ ',
              style: TextStyle(fontSize: 10, color: champagneGold)),
          Expanded(
              child: Text(text,
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: 11, color: textSoft.withOpacity(0.9), height: 1.6),
          ),
        ],
      ),
    );
              ...
              child: Row(
                ...
                children: [
                  Text(
                    c['label'] as String,
                    style: TextStyle(
                        fontSize: 13, color: isDanger ? crisisText : textSoft),
                  ),
                  Text(
                    '→',
                    style: TextStyle(
                        fontSize: 16, color: isDanger ? crisisText : textSoft),
                  ),
                ],
              ),
            );
      ...
      child: Column(
        children: [
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: 11, color: paleLilac.withOpacity(0.9), height: 1.6),
          ),
        ],
      ),
    );
