  ...
  final List<Map<String, dynamic>> _entries = [
    {
      ...
      'desc':
          'After a difficult dinner, your child paused, came back 10 minutes later, and said sorry. ✨',
      'mood': '🥹',
      'core': true,
    ...
    },
    {
      ...
      'desc':
          'Coach said they\'re ready for Level 4. Growth isn\'t always loud — sometimes it\'s quiet persistence.',
      'mood': '🏊',
      'core': false,
      'filter': 'Milestones',
    },
    {
      ...
      'desc':
          '"Look, they\'re learning from me!" — First time taking pride in being the big one.',
      'mood': '💕',
      'core': true,
      'filter': 'Core Memories',
    },
        ...
        child: Column(
          ...
          children: [
                  ...
                  return GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:
                            Border.all(color: active ? lunaPurple : lineSoft),
                      ),
                      child: Text(
                        f,
                        style: TextStyle(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(
                        fontSize: 12, color: textMuted.withOpacity(0.8)),
                  ),
                ],
              ),
            ),
            ...
            Padding(
              ...
              child: Column(
                children:
                    filtered.map((entry) => _buildMemoryCard(entry)).toList(),
              ),
            ),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(
                      fontSize: 12, color: textMuted, height: 1.65),
                ),
                if (entry['core'] == true) ...[
                  const SizedBox(height: 6),
                  const Row(
                    children: [
                      Text('★ ',
                          style: TextStyle(fontSize: 12, color: champagneGold)),
                      Text('Core Memory',
                          style: TextStyle(
                              fontSize: 9,
                              color: champagneGold,
